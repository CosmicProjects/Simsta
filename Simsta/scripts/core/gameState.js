...
const GROWTH_RATES = {
  ...
  followerMultiplier: 0.00005,
  baseLikeGrowth: 0.5,
  likeMultiplier: 0.00015,
  baseShareGrowth: 0.2,
  shareMultiplier: 0.00005,
  baseCommentGrowth: 0.3,
  commentMultiplier: 0.00005,
  baseViewGrowth: 1,
  viewMultiplier: 0.0003,
  baseVideoLikeGrowth: 0.8,
  videoLikeMultiplier: 0.0003,
  baseVideoShareGrowth: 0.3,
  videoShareMultiplier: 0.00015,
  baseVideoCommentGrowth: 0.5,
  videoCommentMultiplier: 0.00015,
...
const VIRAL_CONFIG = {
  ...
  likesMultiplier: 50,
  sharesMultiplier: 30,
  commentsMultiplier: 40,
  followersMultiplier: 20,
  durationMs: 10000,
